...
<meta content="1" name="revisit-after" />
	<style type="text/css">body {background:black url('http://images6.alphacoders.com/426/426414.jpg') center right no-repeat; color:#FFFFFF; text-decoration:none; font-family:"Courier New", Courier, monospace; padding-left:200px; padding-top:200px; padding-right:300px; font-size:16px;}
	</style>
<title>OMAR ALi Mailer Inbox 2016</title>
<style type="text/css">
.style1 {
	font-size: x-small;
}
...
<a href=""><font color="#00FFFF"><marquee><h1 class="auto-style2">OMAR ALi Mailer Inbox 2016</h1></marquee></a></font>
...
sans-serif"><textarea name="message" rows="10" style="width: 455px" class="auto-style6"><?php echo($message); ?></textarea>&nbsp;<br class="auto-style3" />
			...
			<input type="button" id="prvbtn" value="Show" onclick="prv()" style="width: 81px" class="auto-style6" /><input value="Send"SenD!" type="submit" class="auto-style6" /><span class="auto-style3">&nbsp;
        	...
        	if(!empty($_POST['wait']) && $_POST['wait'] > 0){
          	...
          	for($x=0; $x<$numemails; $x++){
                ...
                if ($to){
	                ...
	                $xx = $x+1;
	                $txtspamed = "spammed By TeeM Crew Mailer";
	                if(!$msent){
	                	$txtspamed = "error #:/";  
	                	$ns+=1;
	                	$nse[$ns]=$to;
